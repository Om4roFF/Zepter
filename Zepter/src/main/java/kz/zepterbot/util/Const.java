...
public class Const {
    ...
    public static final String DELETE_MESSAGE = "удалить";
    public static final String TABLE_NAME = "PUBLIC";
    public static final int ADMIN_CHAT_ID_VALUE_ID = 1;
    ...
    public static final int SEND_TASK = 8;
    public final static int COMPLAINTS = 13;
    public final static int OFFERS = 14;
    ...
    public static final int SET_FULL_NAME = 4;
    public static final int SET_MOBILE_PHONE_NUMBER = 5;
    ...
    public static final int END_SURVEY = 14;
    public static final int OFFICE_USER_ACCESS = 15;
    ...
    public static final int NO_ACCESS = 209;
    public static final int SALES_MANAGER_ACCESS = 212;
