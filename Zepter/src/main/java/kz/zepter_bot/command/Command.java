...
public abstract class Command {
    ...
    protected void sendMessageWithAddition() throws TelegramApiException {
        ...
        kz.zepter_bot.entity.standart.Message message = messageDao.getMessage(messageId);
